<#
.SYNOPSIS
    Retrieves historical trades data for stocks from the Alpaca API.

.DESCRIPTION
    This function retrieves historical trades data for stocks from the Alpaca API based on the specified symbols, timeframe, timeframe interval, start date, end date, and other optional parameters.
...
.EXAMPLE
    Get-AlpacaStockHistoricalTrades -Symbols "AAPL" -Timeframe 1 -TimeframeInterval "Hour" -Start "2023-01-01" -End "2023-01-07"
    Retrieves hourly historical trades data for AAPL stock from January 1st, 2023, to January 7th, 2023.
#>

Function Get-AlpacaStockHistoricalTrades {
    [CmdletBinding()]
    Param (
